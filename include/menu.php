                    ...
                    <div class="logo-side center blue-grey darken-3">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            if (!empty($data['alamat'])) {
                                ...
                                echo '<p class="description-side">Jalan Kiara Payung KM. 4,7 Jatinangor Sumedang Jawa Barat Tlp. (022)7790048 Fax (022)7790045, 7790045 Website: http://bandung.lan.go</p>';
                            }
                        }
                        ?>
                    </div>
