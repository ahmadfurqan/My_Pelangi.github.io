                ...
                if (
                    ...
                    if (!preg_match("/^[a-zA-Z0-9. -]*$/", $nama)) {
                        ...
                        if (!preg_match("/^[a-zA-Z0-9. -]*$/", $institusi)) {
                            $_SESSION['institusi'] = 'Form Nama Kantor hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan minus(-)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {
                            ...
                            if (!preg_match("/^[a-zA-Z0-9.,:\/<> -\"]*$/", $status)) {
                                ...
                                if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)) {
                                    ...
                                    if (!preg_match("/^[a-zA-Z., ]*$/", $kepsek)) {
                                        $_SESSION['kepsek'] = 'Form Nama Kepala Pusat hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                        echo '<script language="javascript">window.history.back();</script>';
                                    } else {

                                        if (!preg_match("/^[0-9 -]*$/", $nip)) {
                                            $_SESSION['nipkepsek'] = 'Form NIP Kepala Pusat hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        ?>
                                        <label for="institusi">Nama Kantor</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        ?>
                                        <label for="kepsek">Nama Kepala Pusat</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        ?>
                                        <label for="nip">NIP Kepala Pusat</label>
                                    </div>
                                    <div class="input-field col s6">
